...
class ScheduleParsingService:
    @classmethod
    async def parse_schedule(cls, db: AsyncSession) -> None:  # sourcery skip: low-code-quality
    ...
    @classmethod
    def _parse(cls) -> Generator[list[LessonsSchedule], None, None]:
        ...
        yield from cls._parse_by_json(docs_dir)

    @classmethod
    def _parse_by_json(cls, docs_dir: str) -> Generator[list[LessonsSchedule], None, None]:
        # Формат json:
        # [
        #     {
